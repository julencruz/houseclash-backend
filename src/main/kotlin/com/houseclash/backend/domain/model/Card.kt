...
import com.houseclash.backend.domain.model.cardlogic.effect.FastTrackEffect
...
enum class CardType(val probability: Int, val effect: CardEffect) {
    ...
    FAST_TRACK(10, FastTrackEffect()),          // Instantly approves all PENDING_REVIEW tasks and awards kudos to assignees.
